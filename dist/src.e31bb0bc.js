...
var CONTRACT_NAME = "jasonzed.testnet" || 'nearStore';
...
var near; // Initialize contract & set global variables
...
function sendToken(_x, _x2, _x3) {
  return _sendToken.apply(this, arguments);
}

function _sendToken() {
  _sendToken = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(_from, _to, _amount) {
    var account, result;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return near.account(_from);

          case 2:
            account = _context2.sent;
            _context2.next = 5;
            return account.sendMoney(_to, // receiver account
...
function fetchProducs() {
  return _fetchProducs.apply(this, arguments);
}

function _fetchProducs() {
  _fetchProducs = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
    var products;
...
function fetchMyProducs() {
  return _fetchMyProducs.apply(this, arguments);
}

function _fetchMyProducs() {
  _fetchMyProducs = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
    var products;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 3:
            ...
            console.log(products);
            products.forEach(function (product) {
              var myAccount = window.accountId;
              var owner = product.owner;
...
function _addProduct() {
  _addProduct = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
    var name, description, brand, image, price;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            _context7.prev = 6;
            _context7.next = 9;
            return window.contract.addProduct({
              name: name,
...
function buyProduct(_x, _x2, _x3) {
  return _buyProduct.apply(this, arguments);
}

function _buyProduct() {
  _buyProduct = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(productId, receiverAccount, amount) {
    var myAccount, result, transactionStatus, isSucceed;
    return regeneratorRuntime.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            myAccount = window.accountId; //console.log(myAccount);

            _context8.next = 3;
            return (0, _utils.sendToken)(myAccount, receiverAccount, amount);

          case 3:
            result = _context8.sent;
            console.log(result);
            transactionStatus = result.status.SuccessValue;
            ...
            _context8.next = 9;
            return contract.buyProduct({
              _id: parseInt(productId),
              _newOwner: myAccount
            });

          case 9:
            isSucceed = _context8.sent;

            if (isSucceed) {
              alert("SUCCEED TO BUY PRODUCT!"); //refresh the page
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 4:
          ...
          $('button.btn_buy').click( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
            var id, owner, price, priceInNear;
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    priceInNear = _nearApiJs.utils.format.parseNearAmount(price.toString());
                    console.log(id + owner + priceInNear);
                    _context2.next = 8;
                    return buyProduct(id, owner, priceInNear);
          ...
          $('button.btn_sell').click( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
            var id, owner, price, priceInNear;
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    price = $(this).attr("price");
                    priceInNear = _nearApiJs.utils.format.parseNearAmount(price.toString());
                    console.log(id + owner + priceInNear); //await buyProduct(id, owner, priceInNear);
...
function signedInFlow() {
  ...
  contractLink.href = contractLink.href.replace('testnet', networkId); //fetch greeting
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","near-api-js":"../node_modules/near-api-js/lib/browser-index.js","./utils":"utils.js","./config":"config.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
